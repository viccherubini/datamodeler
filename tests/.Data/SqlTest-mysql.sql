...
CREATE TABLE large_object (large_object_id SMALLINT(3) NOT NULL AUTO_INCREMENT PRIMARY KEY, object_data BLOB NOT NULL) ENGINE = MYISAM CHARACTER SET utf8 COLLATE utf8_unicode_ci;
ALTER TABLE large_object CHANGE object_data object_data TEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL;