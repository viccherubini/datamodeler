...
/**
 * Handles a result set from an Artisan System query.
 * @author vmc <vmc@leftnode.com>
 */
class DataAdapterResultArtisan extends DataAdapterResult {
	
	/**
	 * I am results!
	 * @param mysqli_result $result The result after a successful query through mysqli.
	 */
	public function __construct(Artisan_Db_Result $result) {
	...
	public function getRowCount() {
		return intval($this->getResult()->numRows());
	}
